...
class XMLTests(Command):
    ...
    def run(self):
        import coverage
        import xmlrunner
        cov = coverage.coverage(source=["trytond.modules.nereid_wiki"])
        cov.start()
...
setup(name='trytond_nereid_wiki',
    ...
    package_dir={'trytond.modules.nereid_wiki': '.'},
    packages=[
        'trytond.modules.nereid_wiki',
        #'trytond.modules.nereid_blog.tests',
    ],
    package_data={
        'trytond.modules.nereid_wiki': info.get('xml', []) \
    ...
    entry_points="""
    [trytond.modules]
    nereid_wiki = trytond.modules.nereid_wiki
    """,
